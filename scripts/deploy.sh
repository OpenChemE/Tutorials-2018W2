...
nbviewer_path="http://nbviewer.jupyter.org/github/OpenChemE/Tutorials-2018W2/blob/master/Notebooks" 
...
git remote set-url origin https://${GH_TOKEN}@github.com/OpenChemE/Tutorials-2018W2.git
